...
namespace NicoplvTools.UiShapesKit.Shapes
{
    ...
    public class Rectangle : MaskableGraphic, IShape
	{
		...
		public UiShapesKit.GeoUtils.OutlineProperties OutlineProperties =
			new UiShapesKit.GeoUtils.OutlineProperties();

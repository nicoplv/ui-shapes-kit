	...
	public class PointsList
	{
		...
		public static bool SetLineData(
			...
			if (
				...
				{
					lineData.PositionNormals[i] = UiShapesKit.GeoUtils.ZeroV2;
					lineData.PositionTangents[i] = UiShapesKit.GeoUtils.ZeroV2;
				}
			...
			if (needsUpdate)
			{
				...
				float distance;
				Vector2 lastUnitTangent = UiShapesKit.GeoUtils.ZeroV2;
				Vector2 currentUnitTangent = UiShapesKit.GeoUtils.ZeroV2;

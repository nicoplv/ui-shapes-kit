...
using RoundedCornerProperties = NicoplvTools.UiShapesKit.GeoUtils.RoundingProperties;
...
namespace NicoplvTools.UiShapesKit.ShapeUtils
{
	public class RoundedRects
	{
			...
			public void OnCheck(Rect rect)
			{
				...
				switch (Type)
				{
					case RoundedType.Uniform:
						...
						UniformRadius = Mathf.Max(UniformRadius, 0.0f);
                        break;
					case RoundedType.Individual:
		...
		public static void AddRoundedRect(
			...
			Vector2 uv,
			ref RoundedCornerUnitPositionData cornerUnitPositions,
			UiShapesKit.GeoUtils.EdgeGradientData edgeGradientData
		) {
			...
			vh.AddVert(center, color, tmpUV, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent);
		...
		static void AddRoundedRectVerticesRing(
			...
			for (int i = 0; i < cornerUnitPositions.TRUnitPositions.Length; i++)
			{
				...
				vh.AddVert(tmpPos, color, tmpUV, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent);
			}

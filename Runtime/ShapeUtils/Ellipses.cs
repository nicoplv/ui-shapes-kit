...
namespace NicoplvTools.UiShapesKit.ShapeUtils
{
	public class Ellipses
	{
		...
		public static void AddCircle(
			...
			Color32 color,
			Vector2 uv,
			ref UiShapesKit.GeoUtils.UnitPositionData unitPositionData,
			NicoplvTools.UiShapesKit.GeoUtils.EdgeGradientData edgeGradientData
		) {

			UiShapesKit.GeoUtils.SetUnitPositionData(
			...
			tmpUVPos.x = 0.5f;
			tmpUVPos.y = 0.5f;
			vh.AddVert(center, color, tmpUVPos, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent);
			...
			vh.AddVert(tmpVertPos, color, tmpUVPos, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent);
		...
		public static void AddRing(
			...
			for (int i = 0; i < ellipseProperties.AdjustedResolution; i++)
			{
				...
				tmpVertPos.z = 0.0f;
				uv.y = 0.0f;
				vh.AddVert(tmpVertPos, color, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent);

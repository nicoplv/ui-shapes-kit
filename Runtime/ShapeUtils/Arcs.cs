	...
	public class Arcs
	{
		...
		public static void AddSegment(
			...
			vh.AddVert(
				...
				color, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent);
			...
			vh.AddVert(tmpPosition, color, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent);
			...
			if (edgeGradientData.IsActive)
			{
				...
				vh.AddVert(
					...
					UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent);

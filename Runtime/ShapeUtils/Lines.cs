...
using RoundingProperties = NicoplvTools.UiShapesKit.GeoUtils.RoundingProperties;
...
namespace NicoplvTools.UiShapesKit.ShapeUtils
{
	public class Lines
	{
		...
		public static void AddLine(
			...
			vh.AddVert(tmpPos, color, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent);

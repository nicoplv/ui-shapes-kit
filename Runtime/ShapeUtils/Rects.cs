...
namespace NicoplvTools.UiShapesKit.ShapeUtils
{
	public class Rects
	{
		...
		public static void AddRect(
			...
			float height,
			Color32 color,
			NicoplvTools.UiShapesKit.GeoUtils.EdgeGradientData edgeGradientData
		) {
			...
			if (edgeGradientData.IsActive)
			{
				...
				UiShapesKit.GeoUtils.AddOffset(
					ref width,
					ref height,
		...
		public static void AddRectRing(
			ref VertexHelper vh,
			UiShapesKit.GeoUtils.OutlineProperties OutlineProperties,
			Vector2 center,
			float width,
			float height,
			Color32 color,
		...
		public static void AddRectVertRing(
			...
			vh.AddVert(tmpPos, color, tmpUVPos, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent);
		...
		public static void AddVerticalTwoColorRect(
			...
			vh.AddVert(topLeft, topColor, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent); // TL
			vh.AddVert(topLeft + UiShapesKit.GeoUtils.RightV3 * width, topColor, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent); // TR
			vh.AddVert(topLeft + UiShapesKit.GeoUtils.DownV3 * height, bottomColor, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent); // BL
			vh.AddVert(topLeft + UiShapesKit.GeoUtils.RightV3 * width + UiShapesKit.GeoUtils.DownV3 * height, bottomColor, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent); // BR
		...
		public static void AddHorizontalTwoColorRect(
			...
			vh.AddVert(topLeft, leftColor, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent); // TL
			vh.AddVert(topLeft + UiShapesKit.GeoUtils.RightV3 * width, rightColor, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent); // TR
			vh.AddVert(topLeft + UiShapesKit.GeoUtils.DownV3 * height, leftColor, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent); // BL
			vh.AddVert(topLeft + UiShapesKit.GeoUtils.RightV3 * width + UiShapesKit.GeoUtils.DownV3 * height, rightColor, uv, UiShapesKit.GeoUtils.ZeroV2, UiShapesKit.GeoUtils.UINormal, UiShapesKit.GeoUtils.UITangent); // BR

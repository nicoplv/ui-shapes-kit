...
using Arc = NicoplvTools.UiShapesKit.Shapes.Arc;
...
public class ArcEditor : GraphicEditor
{
	...
	public override void OnInspectorGUI()
	{
		...
		if (capExpanded)
		{
			...
			if (lineCapProp.enumValueIndex == (int)NicoplvTools.UiShapesKit.ShapeUtils.Lines.LineProperties.LineCapTypes.Round)
			{

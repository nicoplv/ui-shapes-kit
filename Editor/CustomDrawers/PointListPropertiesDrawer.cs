...
using PointListProperties = NicoplvTools.UiShapesKit.ShapeUtils.PointsList.PointListProperties;
using PointListGeneratorData = NicoplvTools.UiShapesKit.ShapeUtils.PointsList.PointListGeneratorData;
...
public class PointListPropertiesDrawer : PropertyDrawer
{
	...
	{
		var polygon = property.serializedObject.targetObject as NicoplvTools.UiShapesKit.Shapes.Polygon;
